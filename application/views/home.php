...
<div class="container" id="home">
	<div class="row">
		<div class="col-md-4 col-sm-6">
			<img src="/assets/girl_head.gif" width="360">
		</div>
		<div class="col-md-4 col-sm-6">
			<div class="row">
			...
			<div id="offer" class="row">
				<p>Just <span>$</span><span>299</span> AT COE!</p>
			</div>
		</div>
		<div class="col-md-4">
			<img class="hidden-sm hidden-xs pull-right" src="/assets/logo_full_color.gif" height = "250" >
		</div>
	</div>
</div>
